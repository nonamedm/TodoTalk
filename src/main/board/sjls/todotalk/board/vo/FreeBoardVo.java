...
public class FreeBoardVo {
	...
	private int    user_idx;    // index
	private String user_id;     //사용자 아이디
	private String free_regdate;  //작성일
	private int    free_readcount; //조회수
	
	public FreeBoardVo(){}
	public FreeBoardVo(int free_idx, String free_title, String free_cont, int user_idx, String user_id,
			String free_regdate, int free_readcount) {
		super();
	...
	public String toString() {
		return "FreeBoardVo [free_idx=" + free_idx + ", free_title=" + free_title + ", free_cont=" + free_cont
				+ ", user_idx=" + user_idx + ", user_id=" + user_id + ", free_regdate=" + free_regdate
				+ ", free_readcount=" + free_readcount + "]";
	}

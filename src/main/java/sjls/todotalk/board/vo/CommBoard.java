...
public class CommBoard {
	...
	public CommBoard() {}
	public CommBoard(String board_name, int comm_idx, String comm_title, String comm_cont, int user_idx, String user_id,
			String comm_regdate, int comm_readcount) {
		super();
	...
	public String toString() {
		return "CommBoard [board_name=" + board_name + ", comm_idx=" + comm_idx + ", comm_title=" + comm_title
